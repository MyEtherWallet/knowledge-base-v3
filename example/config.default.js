...
var config = {
  ...
  site_title: 'MyEtherWallet Knowledge Base',

  // The base URL of your site (can use %base_url% in Markdown files)
  base_url: '',

  // Used for the "Get in touch" page footer link
  support_email: 'support@myetherwallet.com',

  // Footer Text / Copyright
  copyright: 'Copyright &copy; '+ new Date().getFullYear() +' - <a rel=”noreferrer noopener” href="https://www.myetherwallet.com">MyEtherWallet LLC</a> - <a rel=”noreferrer noopener” href="http://raneto.com">Powered by Raneto</a>',
