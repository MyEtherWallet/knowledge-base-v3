...
function create_meta_info (meta_title, meta_description, meta_sort, meta_category) {

  var yamlDocument = {};
  var meta_info_is_present = meta_title && meta_description && meta_sort && meta_category;
