...
You can get 0.5% back by manually revealing, [as written up here](https://kb.myetherwallet.com/ens/manually-revealing-ens-bid.html). Unfortunately, you must reveal during the reveal period in order to win  the name, or get the full amount back.
